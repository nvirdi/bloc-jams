...
var setCurrentTimeInPlayerBar = function(currentTime){
  var timeText = filterTimeCode(currentTime);
  $('.current-time').text(timeText);
}

var setTotalTimeInPlayerBar = function(totalTime){
  var timeText = filterTimeCode(totalTime);
  $('.total-time').text(timeText);
}
...
var filterTimeCode = function (timeInSeconds) {
  ...
  if(seconds){
    var realSeconds = '';
    console.log('seconds 11', seconds)
    if(seconds.length < 2){
    ...
    // console.log(minutes)
    return minutes.toString() +  ':' + realSeconds.toString().substring(0,2);
  }
  return '0:00'
}
